...
<div class="main-content">
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="admin-page-title">Identity Verification #{{ $verification->id }}</h4>
                <p class="admin-page-subtitle">Review submitted identity documents</p>
            </div>
            <a href="{{ route('admin.users.identity-verifications.index', $user->id) }}" class="btn btn-sm"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="admin-card">
                    <div class="card-body">
                        <h6 style="color:var(--heading-color);" class="mb-3">Front Photo</h6>
                        <div class="text-center">
                            <img src="{{ asset($verification->front_photo_path) }}" class="img-fluid rounded"
            ...
            <div class="col-md-6">
                <div class="admin-card">
                    <div class="card-body">
                        <h6 style="color:var(--heading-color);" class="mb-3">Back Photo</h6>
                        <div class="text-center">
                            <img src="{{ asset($verification->back_photo_path) }}" class="img-fluid rounded"
                                style="max-height:500px;">
                        </div>
                    </div>
                </div>
