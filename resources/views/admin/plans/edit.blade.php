...
<div class="main-content">
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="admin-page-title">Edit Plan</h4>
                <p class="admin-page-subtitle">Update plan details</p>
            </div>
                ...
                <div class="admin-card">
                    <form id="editPlanForm" method="POST" action="{{ route('admin.plans.update', $plan->id) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="admin-form-control" value="{{ $plan->name }}"
                                required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label" style="color:var(--heading-color);">Price ($)</label>
                            <input type="number" step="0.01" name="price" class="admin-form-control"
                        ...
                        <div class="mb-3">
                            <label class="form-label" style="color:var(--heading-color);">Number of Trading
                                Pairs</label>
                            <input type="number" name="pairs" class="admin-form-control" value="{{ $plan->pairs }}"
                                required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label" style="color:var(--heading-color);">Leverage (optional)</label>
                            <input type="text" name="leverage" class="admin-form-control" value="{{ $plan->leverage }}"
                                placeholder="e.g. 1:500">
                        </div>
                        <div class="mb-3">
                            <label class="form-label" style="color:var(--heading-color);">Spread (optional)</label>
                            <input type="text" name="spread" class="admin-form-control" value="{{ $plan->spread }}"
                                placeholder="e.g. 0.8 pips">
                        </div>
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-admin-primary">Update Plan</button>
