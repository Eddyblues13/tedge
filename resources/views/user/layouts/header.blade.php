...
<head>
    ...
    <meta property="og:description"
        content="Tradedgepip - Live Charts with Indicators, Foreign Exchange Market Trading Methods, Hours, Sessions, &amp; Plans, Major and Minor Pairs Currency, Bullish and Bearish Divergence" />
...
<body>
    ...
    <div class="top-nav">
        <div class="d-flex align-items-center">
            ...
            <div class="mt-1"><a href="#" class="text-decoration-none text-white fw-bold fs-5">Tradedgepip</a>
            </div>
        </div>
