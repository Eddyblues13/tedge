...
class AdminController extends Controller
{
    ...
    public function manageKycPage()
    {
        $data['kyc'] = User::leftJoin('documents', 'users.id', '=', 'documents.user_id')
            ->get(['users.id as real_user_id', 'users.email', 'users.first_name', 'users.last_name', 'users.kyc_status', 'documents.*']);
    ...
    public function leaveImpersonate()
    {
        ...
        if (session()->has('impersonate')) {
            ...
            $data['users'] = User::select('users.id', 'users.first_name', 'users.last_name', 'users.email', 'users.created_at')
